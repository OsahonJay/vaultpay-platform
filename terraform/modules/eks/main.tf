...
resource "aws_iam_role" "cluster" {
  name = "${var.environment}-vaultpay-eks-cluster-role"
...
resource "aws_iam_role" "node_group" {
  name = "${var.environment}-vaultpay-eks-node-role"
...
resource "aws_eks_node_group" "main" {
  ...
  node_group_name = "${var.environment}-vaultpay-nodes"
  ...
  tags = {
    Name        = "${var.environment}-vaultpay-node-group"
    environment = var.environment
    managed-by  = "terraform"
    cost-centre = "platform"
  }
